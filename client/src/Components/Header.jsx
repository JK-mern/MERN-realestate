    ...
    <header className="bg-slate-200 shadow-xl">
      <div className="flex  justify-between items-center  max-w-6xl mx-auto p-3">
        ...
        <ul className="flex items-center gap-4">
          ...
          <Link to="/profile">
            {currentUser ? <img  className='rounded-full h-7 w-7 object-cover' src={currentUser.avatar} />  :<li className="text-slate-600 hover:underline  hover:scale-105">Sign in</li>  
